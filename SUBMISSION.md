...
3. **Retrieval over the full handbook.** At ten entries, putting the whole knowledge base in the prompt is right. At five hundred it isn't, and a retrieval step introduces a failure mode this design currently doesn't have: a miss would report a false knowledge gap.
